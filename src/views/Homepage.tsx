      ...
      >
        ...
        <section className="relative h-[80vh] sm:h-screen flex items-center justify-center">
          ...
          <motion.div
            ...
            style={{ backgroundImage: `url('/hero-bg.jpg')` } as HTMLMotionProps<'div'>['style']}
            initial={{ scale: 1.1 }}
        ...
        <section
          id="about"
          className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-32"
        >
          <div className="absolute inset-0 pointer-events-none">
            <div className="w-48 sm:w-64 h-48 sm:h-64 bg-gradient-to-br from-rose-100 via-white to-transparent rounded-full blur-3xl opacity-60 absolute -top-24 -left-24"></div>
            <div className="w-56 sm:w-80 h-56 sm:h-80 bg-gradient-to-tr from-indigo-100 via-white to-transparent rounded-full blur-3xl opacity-50 absolute -bottom-32 -right-32"></div>
          </div>
